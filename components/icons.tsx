...
export function UsersIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className}>
      ...
      <path d="M17 12.5c2.9.4 5 2.6 5 5.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function MapPinIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className}>
      <path d="M12 21s7-6.5 7-11.5a7 7 0 10-14 0C5 14.5 12 21 12 21z" strokeLinecap="round" strokeLinejoin="round" />
